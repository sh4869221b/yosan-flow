...
describe("period APIs", () => {
  ...
  it("returns summary and day histories under period path", async () => {
    ...
    const addResponse = await fixture.addDay({
      ...
      request: new Request("http://localhost/api/periods/p-2026-04/days/2026-04-20/add", {
        method: "POST",
        headers: { "content-type": "application/json" },
    ...
    const overwriteResponse = await fixture.overwriteDay({
      params: { periodId: "p-2026-04", date: "2026-04-20" },
      request: new Request("http://localhost/api/periods/p-2026-04/days/2026-04-20/overwrite", {
        method: "PUT",
        headers: { "content-type": "application/json" },
    ...
    const periodResponse = await fixture.getPeriod({
      ...
      request: new Request("http://localhost/api/periods/p-2026-04", { method: "GET" })
    } as any);
    ...
    const historyResponse = await fixture.getHistory({
      params: { periodId: "p-2026-04", date: "2026-04-20" },
      request: new Request("http://localhost/api/periods/p-2026-04/days/2026-04-20/history", {
        method: "GET"
      })
    } as any);
    ...
    const missingHistoryResponse = await fixture.getHistory({
      ...
      request: new Request("http://localhost/api/periods/missing-period/days/2026-04-20/history", {
        method: "GET"
      })
    } as any);
  ...
  it("rejects shrinking a period when entries would fall outside the new range", async () => {
    ...
    const addResponse = await fixture.addDay({
      ...
      request: new Request("http://localhost/api/periods/p-shrink/days/2026-05-19/add", {
        method: "POST",
        headers: { "content-type": "application/json" },
