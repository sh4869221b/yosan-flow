...
| configuration/spending completeness、offscreen/stale/generation による結果棄却                                                        | `tests/unit/day-entry-controller-review-races.test.ts`、`dashboard-day-entry-save-race.spec.ts`、`dashboard-day-entry-save-session-race.spec.ts`、`dashboard-history-mutation-races.spec.ts`、`tests/unit/dashboard-history-period-return.test.ts` | #350/#351/#363 が各 lifecycle を維持。offscreen、old generation、hidden period の結果を publish しない                                     |
...
| `tests/e2e/dashboard-day-entry-save-race.spec.ts`、`dashboard-day-entry-save-session-race.spec.ts`、`tests/unit/day-entry-controller-review-races.test.ts`                                                                          | Day Entry generation/session/result adoption は #350。save race、reopened same-day、old-day refresh、fuller concurrent summary の保護を #334 へ先送りしない                                                                                                               |
